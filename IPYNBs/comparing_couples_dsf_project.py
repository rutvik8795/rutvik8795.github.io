# -*- coding: utf-8 -*-
"""Comparing_Couples_DSF_Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1J1buASV5tepyhpYFdoj5CXTZQPriLrT3
"""
...
data = pd.read_csv('/content/drive/My Drive/2016/'+filename, sep="\t", header=None,low_memory=False)        
            ...
            if group1.shape[0]==2:
                ...
                if birthdateDiff < fifteenYears:
                  ...
                  if (group1.iloc[0,13] == group1.iloc[1,13]) :
                    ...
                    tempCouples1[["Voter_ID_Male", "Name_First_Male", "Name_Last_Male", "Birth_Date", "Party_Affiliation_Male"]] = couples1AllColumnsMale[['Voter ID', 'Name First', 'Name Last', 'Birth Date', 'Party Affiliation']]
